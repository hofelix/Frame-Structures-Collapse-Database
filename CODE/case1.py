...
input1 = np.genfromtxt ('C:/Users/user/blender-2.79b-windows64/431.csv', delimiter=",")
input2 = np.genfromtxt ('C:/Users/user/blender-2.79b-windows64/999.csv', delimiter=",")
...
#print(r1[4:20])
str_list =    str(np.sum(dis[0:4])/4) +'\n' + str(np.sum(dis[4:20])/16)+'\n'\
            + str(np.sum(dis[20:36])/16) +'\n'+ str(np.sum(dis[36:46])/12)+'\n'+  str(np.sum(dis[52:132])/80)+'\n'\
            \
            + str(np.sum(data[0:4])/4) +'\n' + str(np.sum(data[4:20])/16)+'\n'\
            + str(np.sum(data[20:36])/16) +'\n'+ str(np.sum(data[36:46])/12)+'\n'+  str(np.sum(data[52:132])/80)+'\n'\
            \
            + str(np.sum(cur[0:4])/4) +'\n' + str(np.sum(cur[4:20])/16)+'\n'\
            + str(np.sum(cur[20:36])/16) +'\n'+ str(np.sum(cur[36:46])/12)+'\n'+  str(np.sum(cur[52:132])/80)+'\n'

fo = open("C:/Users/USER/Desktop/OUTPUT/OUTPUT1/999.csv", "w")
fo.write( str_list )
