...
input = np.genfromtxt('C:/Users/USER/Desktop/OUTPUT/OUTPUT6/all.csv')
input = np.reshape(input,(1000,30))
...
for i in range(0,30):
    ...
    #print(nor[21])
    data.append(nor)
data = np.reshape(data,(1000,30))
#data = list(data)
#fo.write( str(data) )
#print(data[:,0])
disout = 0.14*data[:,0]+0.14*data[:,1]+0.15*data[:,2]+0.14*data[:,3]+0.14*data[:,4]+0.14*data[:,5]+0.15*data[:,6]
disin = 0.7*data[:,7]+0.15*data[:,8]+0.15*data[:,9]
cosout = 0.14*data[:,10]+0.14*data[:,11]+0.15*data[:,12]+0.14*data[:,13]+0.14*data[:,14]+0.14*data[:,15]+0.15*data[:,16]
cosin = 0.7*data[:,17]+0.15*data[:,18]+0.15*data[:,19]
curout = 0.14*data[:,20]+0.14*data[:,21]+0.15*data[:,22]+0.14*data[:,23]+0.14*data[:,24]+0.14*data[:,25]+0.15*data[:,26]
curin = 0.7*data[:,27]+0.15*data[:,28]+0.15*data[:,29]
...
#    plt.annotate(txt,(disin[i],disout[i]))
