...
input1 = np.genfromtxt ('C:/Users/user/Downloads/blender-2.79b-windows64/29.csv', delimiter=",")
...
str_list =    str(np.sum(dis[0:8])/8) +'\n' + str(np.sum(dis[120:152])/32)+'\n'\
            + str((np.sum(dis[104:120])+np.sum(dis[152:168]))/32) +'\n'\
            + str((np.sum(dis[88:90])+np.sum(dis[94:104]))/12)+'\n'\
            + str((np.sum(dis[168:178])+np.sum(dis[182:184]))/12)+'\n'\
            + str((np.sum(dis[178:182])+np.sum(dis[184:264]))/80)+'\n'+ str(np.sum(dis[8:94])/80)+'\n'\
            \
            + str(np.sum(data[0:8])/8) +'\n' + str(np.sum(data[120:152])/32)+'\n'\
            + str((np.sum(data[104:120])+np.sum(data[152:168]))/32) +'\n'\
            + str((np.sum(data[88:90])+np.sum(data[94:104]))/12)+'\n'\
            + str((np.sum(data[168:178])+np.sum(data[182:184]))/12)+'\n'\
            + str((np.sum(data[178:182])+np.sum(data[184:264]))/80)+'\n'+ str(np.sum(data[8:94])/80)+'\n'\
            \
            + str(np.sum(cur[0:8])/8) +'\n' + str(np.sum(cur[120:152])/32)+'\n'\
            + str((np.sum(cur[104:120])+np.sum(cur[152:168]))/32) +'\n'\
            + str((np.sum(cur[88:90])+np.sum(cur[94:104]))/12)+'\n'\
            + str((np.sum(cur[168:178])+np.sum(cur[182:184]))/12)+'\n'\
            + str((np.sum(cur[178:182])+np.sum(cur[184:264]))/80)+'\n'+ str(np.sum(cur[8:94])/80)+'\n'

fo = open("C:/Users/USER/Desktop/OUTPUT/OUTPUT3/999.csv", "w" )
fo.write( str_list )
